...
save_button = Button(screen_width // 2 - 150, 10, save_img)
load_button = Button(screen_width // 2 + 50,  10, load_img)
...
while run:
    ...
    draw_text(f'Level: {level}', font, white, tile_size, 10)
    draw_text('Press UP or DOWN to change level', font, white, tile_size, 25)
